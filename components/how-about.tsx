  ...
  return (
    <div className="min-h-screen flex flex-col items-center  space-y-8 justify-center">
      ...
      <div className="grid grid-cols-1 gap-4 max-w-6xl mx-auto px-4">
        <div className="px-6 py-6 font-light rounded-lg bg-radial from-white/0 to-white/20 backdrop-blur-md text-slate-100 border border-white/30 hover:border-white/90 shadow-lg hover:bg-white/20 transition flex flex-col">
          <h3 className="text-2xl font-semibold text-slate-50">
            <span className="text-4xl font-light mr-2">1.</span> Encontramos tu
            estilo
          </h3>
        ...
        <div className="px-6 py-6 font-light rounded-lg bg-radial from-white/0 to-white/20 backdrop-blur-md text-slate-100 border border-white/30 hover:border-white/90 shadow-lg hover:bg-white/20 transition flex flex-col">
          <h3 className="text-2xl font-semibold text-slate-50">
            <span className="text-4xl font-light mr-2">2.</span> Creamos tu web
          </h3>
          <p className="text-slate-300 mt-2">
        ...
        <div className="px-6 py-6 font-light rounded-lg bg-radial from-white/0 to-white/20 backdrop-blur-md text-slate-100 border border-white/30 hover:border-white/90 shadow-lg hover:bg-white/20 transition flex flex-col">
          <h3 className="text-2xl font-semibold text-slate-50">
            <span className="text-4xl font-light mr-2">3.</span> Posicionamos tu
            negocio
          </h3>
          <p className="text-slate-300 mt-2">
        ...
        <div className="px-6 py-6 font-light rounded-lg bg-radial from-white/0 to-white/20 backdrop-blur-md text-slate-100 border border-white/30 hover:border-white/90 shadow-lg hover:bg-white/20 transition flex flex-col">
          <h3 className="text-2xl font-semibold text-slate-50">
            <span className="text-4xl font-light mr-2">4.</span> Resultados
          </h3>
          <p className="text-slate-300 mt-2">
